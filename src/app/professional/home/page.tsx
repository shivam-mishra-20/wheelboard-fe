...
export default function ProfessionalHomePage() {
  ...
  const slides = [
    { id: 1, image: '/profile-pic.png', alt: 'Professional spotlight' },
    { id: 2, image: '/live-truck.gif', alt: 'On trip' },
    { id: 3, image: '/truck-01.jpg', alt: 'Professional services' },
  ];
        ...
        <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-6">
              {['Search', 'Trips', 'Feeds', 'Jobs', 'Profile', 'Support'].map(
                (label) => (
                  <div
                    key={label}
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4">
              {[
                { title: 'Local Driver', img: '/staring-man.jpg' },
                { title: 'Site Technician', img: '/excavator.jpg' },
              ].map((job) => (
                <div
                  key={job.title}
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Short description for the opportunity
                    </p>
              ...
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="rounded-2xl bg-white p-6 shadow-sm">
                  ...
                  <p className="mb-3 text-sm text-gray-600">
                    Short feed description about trips or certifications
                  </p>
